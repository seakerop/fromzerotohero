...
// Cada momento lleva su susurro: un mensaje SOBRIO que constata el hecho.
// Tono acordado: siempre positivo y de avance, sin culpabilizar jamás y sin
// dopamina fácil — nada de hipérboles ni exclamaciones infladas; el hecho
// real es la recompensa.
export const MOMENTOS_ARBOL = [
  { dia: 0, etiqueta: 'La semilla', mensaje: 'Tu semilla está plantada.' },
  { dia: 2, etiqueta: 'La grieta', mensaje: 'La cáscara se ha agrietado. Algo empuja.' },
  { dia: 4, etiqueta: 'La primera raíz', mensaje: 'Una raíz nueva se agarra a la tierra.' },
  { dia: 6, etiqueta: 'La segunda raíz', mensaje: 'Otra raíz más. Bajo tierra ya hay trabajo hecho.' },
  { dia: 8, etiqueta: 'El germen', mensaje: 'El germen empuja hacia arriba, aunque no se vea.' },
  { dia: 11, etiqueta: 'A un dedo de la luz', mensaje: 'Está a un dedo de la luz.' },
  { dia: 14, etiqueta: 'El brote', mensaje: 'Tu brote ha cruzado la superficie.' },
  { dia: 17, etiqueta: 'La tercera hoja', mensaje: 'Ha brotado una hoja nueva.' },
  { dia: 20, etiqueta: 'La cuarta hoja', mensaje: 'Ha brotado una hoja nueva.' },
  { dia: 24, etiqueta: 'La quinta hoja', mensaje: 'Ha brotado una hoja nueva.' },
  { dia: 28, etiqueta: 'El penacho', mensaje: 'El penacho verdea.' },
  { dia: 33, etiqueta: 'La base se endurece', mensaje: 'Lo tierno se está volviendo madera.' },
  { dia: 38, etiqueta: 'La primera rama', mensaje: 'Tu constancia ha echado su primera rama.' },
  { dia: 44, etiqueta: 'Hojas en la rama', mensaje: 'La rama nueva ya tiene hojas.' },
  { dia: 50, etiqueta: 'La segunda rama', mensaje: 'Tu constancia ha echado una rama nueva.' },
  { dia: 57, etiqueta: 'Más follaje', mensaje: 'Más follaje en tu copa.' },
  { dia: 64, etiqueta: 'Ya es tronco', mensaje: 'Ya no es un tallo. Es un tronco.' },
  { dia: 72, etiqueta: 'La tercera rama', mensaje: 'Tu constancia ha echado una rama nueva.' },
  { dia: 80, etiqueta: 'La copa se une', mensaje: 'Las ramas se han encontrado: ya hay copa.' },
  { dia: 85, etiqueta: 'El primer lucero', mensaje: 'Un lucero nuevo vela tu camino.' },
  { dia: 92, etiqueta: 'Una seta al pie', mensaje: 'Ha brotado una seta al pie del árbol.' },
  { dia: 100, etiqueta: 'Musgo en el tronco', mensaje: 'Cien días. El musgo ya abraza el tronco.' },
  { dia: 115, etiqueta: 'Raíces a la vista', mensaje: 'Tus raíces ya se ven. Lo importante pasaba donde no se veía.' },
  { dia: 125, etiqueta: 'La cuarta rama', mensaje: 'Tu constancia ha echado una rama nueva.' },
  { dia: 135, etiqueta: 'Un nido', mensaje: 'Alguien ha hecho nido en tu árbol.' },
  { dia: 150, etiqueta: 'El segundo lucero', mensaje: 'Otro lucero se suma a tu camino.' },
  { dia: 160, etiqueta: 'La copa se abre', mensaje: 'La copa se está abriendo camino.' },
  { dia: 165, etiqueta: 'Llega un pájaro', mensaje: 'Un pájaro ha elegido tu árbol.' },
  { dia: 180, etiqueta: 'Hierba alta', mensaje: 'La hierba crece a su sombra.' },
  { dia: 190, etiqueta: 'El primer capullo', mensaje: 'Un capullo asoma en la copa.' },
  { dia: 198, etiqueta: 'La flor se abre', mensaje: 'Florece lo que sembraste.' },
  { dia: 200, etiqueta: 'La quinta rama', mensaje: 'Tu constancia ha echado una rama nueva.' },
  { dia: 210, etiqueta: 'Tres flores', mensaje: 'Florece lo que sembraste.' },
  { dia: 220, etiqueta: 'La copa gana altura', mensaje: 'La copa gana altura.' },
  { dia: 225, etiqueta: 'Floración', mensaje: 'Tu árbol está en plena floración.' },
  { dia: 240, etiqueta: 'El primer fruto', mensaje: 'Los esfuerzos están dando frutos.' },
  { dia: 255, etiqueta: 'Más frutos', mensaje: 'Los esfuerzos están dando frutos.' },
  { dia: 270, etiqueta: 'La cosecha', mensaje: 'La copa está cargada: es la cosecha.' },
  { dia: 280, etiqueta: 'La copa se extiende', mensaje: 'La copa se extiende un poco más.' },
  { dia: 285, etiqueta: 'Una luciérnaga', mensaje: 'Una luciérnaga ronda tu copa.' },
  { dia: 300, etiqueta: 'El tercer lucero', mensaje: 'Trescientos días. Otro lucero en tu cielo.' },
  { dia: 310, etiqueta: 'La segunda seta', mensaje: 'Otra seta al pie del árbol.' },
  { dia: 320, etiqueta: 'La rama colgante', mensaje: 'Una rama se inclina, madura.' },
  { dia: 340, etiqueta: 'El primer oro', mensaje: 'Hay oro en las ramas.' },
  { dia: 365, etiqueta: 'Árbol del Héroe', mensaje: 'Un año de camino. El árbol es dorado.' },
  { dia: 385, etiqueta: 'El cuarto lucero', mensaje: 'Otro lucero vela tu camino.' },
  { dia: 410, etiqueta: 'Otra luciérnaga', mensaje: 'Otra luciérnaga ronda tu copa.' },
  { dia: 425, etiqueta: 'Noche de luciérnagas', mensaje: 'Esta noche tu copa está llena de luciérnagas.' },
  { dia: 450, etiqueta: 'Leyenda', mensaje: 'Las estrellas anidan en tu copa.' },
]
...
// Momentos cruzados entre dos recuentos de días de acción (para el susurro).
export function momentosEntre(desde, hasta) {
  return MOMENTOS_ARBOL.filter((m) => m.dia > desde && m.dia <= hasta)
}

export const MENSAJES_ESTACION = {
  primavera: 'La primavera ha florecido en tu árbol.',
  verano: 'El verano llena tu copa de verde.',
  otono: 'El otoño ha vestido tu árbol de ámbar.',
  invierno: 'Primera nieve sobre tu copa.',
}
